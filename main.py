...
class Pet:
    ...
    def __init__(self):
        ...
        self.feed = Pet.pet_list[self.pet]['feed']
        self.active = Pet.pet_list[self.pet]['active']
        self.rarity = Pet.pet_list[self.pet]['rarity']
...
class Human:
    ...
    def status(self, day):
        ...
        if self.pet is not None:
            pet_info = f'{self.pet.pet} pet info'
            print(f'{pet_info:^50}')
            print('\n')
            print(f'feed: {self.pet.feed}')
            print(f'active: {self.pet.active}')
